# Copilot Instructions — `logging-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/logging-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/logging-microservice.git`, branch `main`.
